...
step (7) = 0
step (6) = [2 + 3 + 2 + (7)] = [2 + 3 + 2 + 0] = 7
step (5) = [3 + 4 + 4 + (6)] = [3 + 4 + 4 + 7] = 18
step (4) = [4 + 5 + 6 + (5)] = [4 + 5 + 6 +18] = 33
step (3) = [5 + 6 + 8 + (4)] = [5 + 6 + 8 + 33] = 52
step (2) = [6 + 7 + 10 + (3)] = [6 + 7 + 10 + 52] = 75
step (1) = [7 + 8 + 12 + (2)] = [7 + 8 + 12 + 75] = 102
